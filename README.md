...
<img src="https://img.shields.io/badge/Kafka%20Connect-231F20?style=flat&logo=apachekafka&logoColor=white"/>
<img src="https://img.shields.io/badge/ZooKeeper-E79537?style=flat"/>
<img src="https://img.shields.io/badge/etcd-419EDA?style=flat"/>
...
- **milvus-io/milvus** — [fix: make a ticket-less resume actually resume garbage collection](https://github.com/milvus-io/milvus/pull/53592)
- **zilliztech/milvus-backup** — [fix: store the renewed ticket when renewing the collection GC lease](https://github.com/zilliztech/milvus-backup/pull/1227)
- **zilliztech/milvus-backup** — [fix(log): correct file logging config](https://github.com/zilliztech/milvus-backup/pull/783)
- **langchain-ai/langchain** — [feat: add a flag that determines whether to load the milvus collection](https://github.com/langchain-ai/langchain/pull/15693)
- **langchain-ai/langchain** — [core: Runnable pass kwargs to _astream_log_implementation in astream_log](https://github.com/langchain-ai/langchain/pull/19055)

## 📫 Contact

<a href="mailto:yhwjjang1995@naver.com"><img src="https://img.shields.io/badge/Email-03C75A?style=flat&logo=naver&logoColor=white"/></a>
<a href="https://rere950303.github.io"><img src="https://img.shields.io/badge/Blog-CC0000?style=flat&logo=jekyll&logoColor=white"/></a>
